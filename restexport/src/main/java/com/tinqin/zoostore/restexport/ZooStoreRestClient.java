...
public interface ZooStoreRestClient {
    ...
    @RequestLine("GET /api/zoostore/items/byTag?title={title}&pageNumber={pageNumber}&pageSize={pageSize}")
    ItemGetByTagResponse getItemsByTagTitle(@Param String title, @Param Integer pageNumber, @Param Integer pageSize);

    @RequestLine("GET /api/zoostore/items/byItem?title={title}&pageNumber={pageNumber}&pageSize={pageSize}")
    ItemGetByTitleResponse getItemsByItemTitle(@Param String title, @Param Integer pageNumber, @Param Integer pageSize);
